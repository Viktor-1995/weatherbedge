...
function Weather({
    ...
    let currentDate = current.time.match(/(.*)T/)[1];
    let currentTime = current.time.match(/T(.*)/)[1];
    let count = currentTime.split(":")[0];
    let k = +count + 24;

    let time = hours.filter((obj, i) => {
        if (i >= count) {
            if (k > i) {
                return obj;
            }
    ...
    let temp = temperature.filter((obj, i) => {
        if (i >= count) {
            if (k > i) {
                return obj ? obj : "0";
            }
    ...
    let precip = precipitation.filter((obj, i) => {
        if (i >= count) {
            if (k > i) {
                return obj ? obj : "0";
            }
    ...
    let day1 = new Day(time, temp, precip);

    return (
        <>
            <div className="weather-wrap">
                <div className="weathertext-wrap">
                    <div className="weathertext-city">
                        <h2>
                            <span className="city-name">{city}</span> currently
                            is {wc}
                        </h2>
                    </div>
                    <div className="weathertext-condition"> {wcsvg} </div>
                </div>
                <div className="weathershow-wrap">
                    <div className="weather-currentday-wrap">
                        <div> Today is {currentDate}</div>
                        <div> {currentTime}</div>
                        <div>
                            {" "}
                            Highest{" "}
                        ...
                        <div>
                            ...
                            {wd} - {current.windspeed} km/h
                        </div>
                    </div>
                    <div className="split-line"></div>
                    <div className="weather-nextdays-wrap">
                        <Table striped>
                            <tbody>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    {day1.precip.map((precip) => {
                                        return <td>{precip} mm</td>;
                                    })}
                                </tr>
                            </tbody>
                        </Table>
